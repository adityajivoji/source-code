...
def main():
    ...
    args.batch_size = 1
    dataset_train = Thor(args.subset, args.past_length, args.future_length, phase="train")
    dataset_test = Thor(args.subset, args.past_length, args.future_length, phase="test")

    loader_train = torch.utils.data.DataLoader(dataset_train, batch_size=1, shuffle=True, drop_last=True,
    ...
    for epoch in range(0, args.epochs):
        ...
        if args.vis:
            visualize(loader_test, model, 0, './thor/img')            
